...
our %config = (
  ...
  options => "--cross-compile-prefix=arm-linux-gnueabihf- enable-shared --prefix=/Users/seear/embedded_codes/99_ForCodexs/2510_RefactorProject/extraLib/openSSL/install-arm --openssldir=/Users/seear/embedded_codes/99_ForCodexs/2510_RefactorProject/extraLib/openSSL/install-arm/ssl no-afalgeng no-asan no-async no-buildtest-c++ no-crypto-mdebug no-crypto-mdebug-backtrace no-devcryptoeng no-ec_nistp_64_gcc_128 no-egd no-external-tests no-fuzz-afl no-fuzz-libfuzzer no-heartbeats no-makedepend no-md2 no-msan no-rc5 no-sctp no-ssl-trace no-ssl3 no-ssl3-method no-tests no-ubsan no-unit-test no-weak-ssl-ciphers no-zlib no-zlib-dynamic",
  perl_archname => "x86_64-linux-gnu-thread-multi",
  perl_cmd => "/usr/bin/perl",
  perl_version => "5.26.1",
  perlargv => [ "linux-armv4", "--cross-compile-prefix=arm-linux-gnueabihf-", "shared", "no-tests", "no-async", "--prefix=/Users/seear/embedded_codes/99_ForCodexs/2510_RefactorProject/extraLib/openSSL/install-arm", "--openssldir=/Users/seear/embedded_codes/99_ForCodexs/2510_RefactorProject/extraLib/openSSL/install-arm/ssl" ],
  perlenv => {
      "AR" => undef,
      "ARFLAGS" => undef,
      "AS" => undef,
