...
our %config = (
  ...
  CPPFLAGS => [  ],
  CPPINCLUDES => [  ],
  CROSS_COMPILE => "/opt/toolchains/imx6ul/gcc-linux-arm-4.9/bin/arm-linux-gnueabihf-",
  CXX => "g++",
  CXXFLAGS => [ "-Wall -O3" ],
  ...
  openssldir => "/workspace/projects/99_ForCodexs/2510_RefactorProject/extraLib/openSSL/install-arm/ssl",
  options => "--cross-compile-prefix=/opt/toolchains/imx6ul/gcc-linux-arm-4.9/bin/arm-linux-gnueabihf- enable-shared --prefix=/workspace/projects/99_ForCodexs/2510_RefactorProject/extraLib/openSSL/install-arm --openssldir=/workspace/projects/99_ForCodexs/2510_RefactorProject/extraLib/openSSL/install-arm/ssl no-afalgeng no-asan no-async no-buildtest-c++ no-crypto-mdebug no-crypto-mdebug-backtrace no-devcryptoeng no-ec_nistp_64_gcc_128 no-egd no-external-tests no-fuzz-afl no-fuzz-libfuzzer no-heartbeats no-md2 no-msan no-rc5 no-sctp no-ssl-trace no-ssl3 no-ssl3-method no-tests no-ubsan no-unit-test no-weak-ssl-ciphers no-zlib no-zlib-dynamic",
  perl_archname => "x86_64-linux-gnu-thread-multi",
  perl_cmd => "/usr/bin/perl",
  perl_version => "5.26.1",
  perlargv => [ "linux-armv4", "--cross-compile-prefix=/opt/toolchains/imx6ul/gcc-linux-arm-4.9/bin/arm-linux-gnueabihf-", "shared", "no-tests", "no-async", "--prefix=/workspace/projects/99_ForCodexs/2510_RefactorProject/extraLib/openSSL/install-arm", "--openssldir=/workspace/projects/99_ForCodexs/2510_RefactorProject/extraLib/openSSL/install-arm/ssl" ],
  perlenv => {
      "AR" => undef,
      "ARFLAGS" => undef,
      "AS" => undef,
  ...
  prefix => "/workspace/projects/99_ForCodexs/2510_RefactorProject/extraLib/openSSL/install-arm",
  processor => "",
