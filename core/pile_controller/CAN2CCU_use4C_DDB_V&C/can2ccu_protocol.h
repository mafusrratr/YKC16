...
public:
    ...
    int encodeMeterData(uint16_t voltage, uint16_t current);
...
private:
    ...
    int encodeMeterDataFrame(uint16_t voltage, uint16_t current);
    ...
    static const uint16_t PGN_METER_DATA = 0x4D;       // 电表电压电流数据
