...
// BY ZF: VirtualVin 协议固定上送/鉴权 VIN，不再从配置文件或外部命令读取
#define CAN2CCU_FIXED_VIN "LJ21BABB8L1001955"

// BY ZF: 单枪负载模拟合并充测试开关；1=合并充启动命令仍下发 0x01，0=按真实合并充下发 0x02
#define CAN2CCU_SINGLE_GUN_LOAD_MERGE_TEST 1
...
private:
    ...
    // BY ZF: 将 VirtualVin 固定 VIN 写入协议业务结构中的 17 字节 VIN 字段
    void copyFixedVin(char* outVin, size_t outLen) const;
