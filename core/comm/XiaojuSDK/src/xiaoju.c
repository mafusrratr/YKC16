			...
			for(j = 0;j < _g_xj_params->gun_cnt; j++){
				if(g_xj_co_charge[j].charge_type == TRUE){
					if(i == j){
						...
						_g_xj_current_bill_info[i].start_charge_kwh_meter += g_xj_gun_status[g_xj_co_charge[j].major_gun].current_meter_kwh_num;//_g_xj_current_bill_info[g_xj_co_charge[i].major_gun].start_charge_kwh_meter;
					}
				}
			}
...
void xj_helper_init_xj_params(xj_params* p,uint8_t gun_cnt)
{
	...
	{
			strncpy(p->equipment_id,hmi_info.cevhost_ini.ip,XJ_MAX_EQUIPMENT_ID_LEN-1);
 ...
 ********************************************************/
int8_t xj_send_charga_param_info()
{
	send_514_all_notify();
	return 0;
}
...
int param_507_item_set_20(void *data, uint16_t len)
{
    int result = 0;
    uint8_t value = *(uint8_t *)data;
    if (xj_phm_read_byte(kXjPhmParamRebootSwitch) != value)
    {
        xj_phm_write_byte(kXjPhmParamRebootSwitch, value);
        result = len;
    }
    return result;
}

int param_507_item_get_20(void *buffer, uint16_t size)
{
    *(uint8_t *)buffer = xj_phm_read_byte(kXjPhmParamRebootSwitch);
    return 1;
}

int param_507_item_set_21(void *data, uint16_t len)
{
    int result = 0;
    uint8_t value = *(uint8_t *)data;
    if (xj_phm_read_byte(kXjPhmParamKwhCtrlSwitch) != value)
    {
        xj_phm_write_byte(kXjPhmParamKwhCtrlSwitch, value);
        result = len;
    }
    return result;
}

int param_507_item_get_21(void *buffer, uint16_t size)
{
    *(uint8_t *)buffer = xj_phm_read_byte(kXjPhmParamKwhCtrlSwitch);
    return 1;
}

//int param_507_item_set_22(void *data, uint16_t len)
//{
//    int result = 0;
//    uint8_t value = *(uint8_t *)data;
//    if (xj_phm_read_byte(kXjPhmParamCardSwitch) != value)
//    {
//        xj_phm_write_byte(kXjPhmParamCardSwitch, value);
//        result = len;
//    }
//    return result;
//}
//
//int param_507_item_get_22(void *buffer, uint16_t size)
//{
//    *(uint8_t *)buffer = xj_phm_read_byte(kXjPhmParamCardSwitch);
//    return 1;
//}
...
int param_507_item_set_22(void *data, uint16_t len)
{
    int result = 0;
    uint8_t value = *(uint8_t *)data;
    if (xj_phm_read_byte(kXjPhmParamCoChargeSwitch) != value)
    {
        xj_phm_write_byte(kXjPhmParamCoChargeSwitch, value);
        result = len;
    }
    return result;
}
...
int param_507_item_get_22(void *buffer, uint16_t size)
{
    *(uint8_t *)buffer = xj_phm_read_byte(kXjPhmParamCoChargeSwitch);
    return 1;
}

int param_507_item_set_23(void *data, uint16_t len)
{
    int result = 0;
    uint8_t value = *(uint8_t *)data;
    if (xj_phm_read_byte(kXjPhmParamOffLineSwitch) != value)
    {
        xj_phm_write_byte(kXjPhmParamOffLineSwitch, value);
        result = len;
    }
    return result;
}

int param_507_item_get_23(void *buffer, uint16_t size)
{
    *(uint8_t *)buffer = xj_phm_read_byte(kXjPhmParamOffLineSwitch);
    return 1;
}
/// 参数表,id需要从小到大依次排列
xj_cmd_507_item g_cmd_507_param[] = 
{
    {0, 1, param_507_item_set_1, param_507_item_get_1},
    {1, 1, param_507_item_set_2, param_507_item_get_2},
    {2, 1, param_507_item_set_3, param_507_item_get_3},
    {3, 1, param_507_item_set_4, param_507_item_get_4},
    {4, 1, param_507_item_set_5, param_507_item_get_5},
    {5, 1, param_507_item_set_6, param_507_item_get_6},
    {6, 1, param_507_item_set_7, param_507_item_get_7},
    {7, 1, param_507_item_set_8, param_507_item_get_8},
    {8, 1, param_507_item_set_9, param_507_item_get_9},
    {9, 1, param_507_item_set_10, param_507_item_get_10},
    {10, 1, param_507_item_set_11, param_507_item_get_11},
    {11, 1, param_507_item_set_12, param_507_item_get_12},
    {12, 1, param_507_item_set_13, param_507_item_get_13},
    {13, 1, param_507_item_set_14, param_507_item_get_14},
    {14, 1, param_507_item_set_15, param_507_item_get_15},
    {15, 1, param_507_item_set_16, param_507_item_get_16},
    {16, 1, param_507_item_set_17, param_507_item_get_17},
    {17, 1, param_507_item_set_18, param_507_item_get_18},
    {18, 1, param_507_item_set_19, param_507_item_get_19},
	{19, 1, param_507_item_set_20, param_507_item_get_20},
	{20, 1, param_507_item_set_21, param_507_item_get_21},
	{21, 1, param_507_item_set_22, param_507_item_get_22},
	{22, 1, param_507_item_set_23, param_507_item_get_23},
//	{24, 1, param_507_item_set_24, param_507_item_get_24},
};
/*
/// 二分法查找返回具体项
...
xj_cmd_507_item* find_507_param_item(uint16_t id)
{
	if( id >= (sizeof(g_cmd_507_param) / sizeof(g_cmd_507_param[0])) || id < 0)
	{
		xj_pal_print_log(xj_log_message,"507 control param item out of range!:%d\n",id);
		return NULL;
	}
	return &g_cmd_507_param[id];
}
...
int param_511_item_ctrl_3(uint16_t param1, uint16_t param2)
{
	uint8_t  dev_id;
	dev_id = param1;
	return callback_dev_reboot_control(dev_id, param2);
}

int param_511_item_ctrl_4(uint16_t param1, uint16_t param2)
{
    return 0;
}

int param_511_item_ctrl_5(uint16_t param1, uint16_t param2)
{
    return 0;
}
...
{
	{0, param_511_item_ctrl_1},     // 电子锁控制
	{1, param_511_item_ctrl_2},     // 地锁控制
	{2, param_511_item_ctrl_3},     // 重启指令
	{3, param_511_item_ctrl_4},     // 地锁启用
	{4, param_511_item_ctrl_5},     // 预约充电控制
};
...
xj_cmd_511_item* find_511_param_item(uint16_t id)
{
	if( id >= (sizeof(g_cmd_511_param) / sizeof(g_cmd_511_param[0])) || id < 0)
	{
		xj_pal_print_log(xj_log_message,"511 control param item out of range!:%d\n",id);
		return NULL;
	}
	return &g_cmd_511_param[id];
}
