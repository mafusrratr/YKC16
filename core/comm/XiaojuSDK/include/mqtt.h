...
//MQTT_ERROR_SEND_BUFFER_IS_FULL -214748348
//MQTT_ERROR_SOCKET_ERROR -214748347
 ...
 */
enum MQTTErrors {
    MQTT_ERROR_UNKNOWN = MQTT_INT_MIN,
...
struct mqtt_client {
    ...
    */
    ...
    /*MQTT  Connect Flag*/
    enMQTT_Connect Connect_status;
    /*MQTT Subscribe Flag*/
	enMQTT_Subscribe Subscribe_status;
